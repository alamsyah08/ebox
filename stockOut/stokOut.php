...
if (isset($_POST['submit'])) {
    ...
    if ($_POST['jumlah'] > 0 and $_POST['jumlah'] <= $jumlahProd) {
                            ...
                            <a href="stokOut.php?id=<?= $data['id']; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2 col-lg-2 text-end">
                                        ...
                                        <p style="font-size:16px;color: red; margin-bottom: 0; margin-top: -4px;">
                                            <?php if (isset($_POST['submit']) && $data['id'] === $id && $_POST['jumlah'] > 0 && $_POST['jumlah'] <= $jumlahProd) {
                                                echo "- " . $_POST['jumlah'];
                                            } ?>
                                        </p>
                                    </div>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="card" style="width: 80%; margin: auto;">
                            <div class="card-body">
                                ...
                                <p class="mt-5" style="font-size: 18px;"><strong> Jumlah Keluaran :
                                        <span style="color:red;">
                                            <?php if (isset($_POST['submit']) && $_POST['jumlah'] > 0 && $_POST['jumlah'] <= $jumlahProd) {
                                                echo $_POST['jumlah'];
                                            } ?>
                                        </span></strong>
                                </p>
                            ...
                            <div class="card-footer text-center">
                                <button class="btn btn-secondary" name="submit"> <strong> Keluarkan </strong> </button>
                            </div>
                        </div>
                    </form>
                </div>
