...
<body>
    ...
    <main style="margin: 80px 10px 0 10px; background-color: white;">
        <div class="container pt-4 mx-auto">
            <h3 class="mt-1">Daftar Produk</h3>
            ...
            <div class="row">
                        ...
                        while ($data = mysqli_fetch_array($result)):
                            ...
                            <a href="detailProduk.php?id=<?= $data['id']; ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-1 col-lg-2" style="float: right;">
                                        <p style="font-size:18px; color:#194FB1; float: right; margin-top: 15px;">
                                            <?= $data['jumlah'] ?>
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="produk col-md-4  mt-4 text-center">
                    <a href="tambah.php" class="btn btn-secondary mx-auto"> <strong> Tambah Produk </strong> </a>
                </div>
            </div>
