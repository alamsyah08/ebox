...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
          <a class="nav-item nav-link active" href="../beranda/beranda.php">Beranda</a>
  ...
  <div class="konten">
      ...
      <div class="container">
        <div class="row atas">
          <div class="col-lg-6 my-auto">
            <h1><strong>Tingkatkan penjualan dengan inventory management online</strong></h1>
            <p class="mt-4">Mengubah cara setiap bisnis dalam melakukan <br> inventorisasi barang dengan mudah dan
              efisien.</p>
            <button type="button" class="btn btn-primary btn-lg " id="btnDaftar"><a
                style="text-decoration: none; color: white; font-size: 22px;"
                href="../daftarLogin/indexDaftar.php"><Strong>Daftar Sekarang</Strong></a></button>
          </div>
          <div class="col">
    ...
    <div class="container">
      <div class="row text-center ">
        <div class="col">
          ...
          <p><span class="eBoxFont">eBox</span> adalah aplikasi berbasis web siap membantu bisnis Anda jadi lebih jauh
    ...
    <div class="container">
      <div class="row justify-content-center" id="stok">
        <div class="col-lg-6 col-md-8 col-sm-12 mx-auto text-center">
          <img src="img/Group 67.png" alt="" class="stok" >
        </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col  mx-auto text-center">
          <img src="img/Group 38.png"  alt="" class="order">
        </div>
      </div>
    </div>
    ...
    <!-- Testimoni Ebox-->
    <div class="container">
      <h2 class=""><strong>Testimoni</strong></h2>
      <br>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">eBox sangat membantu dalam memantau stok barang di toko saya jadi saya tidak
                kehabisan stok. Maju terus dan jaya selalu buat eBox ...</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Dulu sebelum menggunakan eBox saya kebingungan dalam mendata stok pakan ikan lele,
                kini saya sudah tidak bingung lagi...</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Saya sangat suka dengan fitur melihat history stok masuk dan keluar sehingga
                memudahkan saya dalam membuat
                laporan penjualan...
              </p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Baru tau ada web dengan fitur se-keren ini, sayang sekali saya baru mengetauinya
